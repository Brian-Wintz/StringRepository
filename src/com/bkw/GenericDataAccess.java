...
System.out.println("read:"+query);
    ...
    public static List<GenericBean<IGenericField, Object>> readFiltered(GenericBean<IGenericField, Object> bean,IGenericField[] fields, String filter) {
        BasicConnectionPool bcp=null;
        Connection conn=null;
        List<GenericBean<IGenericField, Object>> list=new ArrayList<>();
        Class c=bean.getClass();
System.out.println("readFiltered:"+bean+":"+c);
        ...
        try {
            ...
            String query="select * from "+bean.getTableName()+" WHERE "+filter;
System.out.println("readFiltered:"+query);
            ResultSet rs = stmt.executeQuery(query);
            while(rs.next()){
